...
namespace EDP_WinProject
{
    public partial class FormOrders : Form
    {
        ...
        {
            string templatePath = Application.StartupPath + @"\reportTemplate\ListofOrders.xlsx";

            DateTime now = DateTime.Now;
            string mydate = now.ToString("yyyy-MM-dd-HH-mm-ss");

            string newFilePath = Application.StartupPath + @"\generatedReports\List of Orders Report-" + mydate + ".xlsx";
